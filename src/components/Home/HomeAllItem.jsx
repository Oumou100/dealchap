    ...
    <div className="container">
      {isLoading ? (
        <div className="row top_spacing product_card_card_gap">
          {[...Array(8)].map((_, index) => (
            <div className="col-xxl-3 col-lg-3 col-md-6 col-6" key={index}>
              <ProductCardSkeleton />
            </div>
          ))}
        </div>
        ...
        >
          <div
            className={`row product_card_card_gap ${
              !allEmpty && "top_spacing"
            }`}
          >
            {AllItemData.map((data, index) => (
              <div
                className="col-xxl-3 col-lg-3 col-md-6 col-6 product_card_card_gap"
                key={index}
              >
                <Link
                  href={
